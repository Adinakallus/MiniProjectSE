...
public class ReflectionRefractionTests {
    ...
    public void allEffectsTest() {
        ...
        scene.geometries.add( //
                new Sphere(450, new Point3D(-600, -477, -1100)) //
                        .setEmission(new Color(0, 0, 100)) //
                        .setMaterial(new Material().setKd(0.25).setKs(0.25).setShininess(20).setKt(0.6)),
                new Sphere(200, new Point3D(-520, -700, -1090)) //
                        .setEmission(new Color(100, 20, 20)) //
        ...
        ImageWriter imageWriter = new ImageWriter("allEffectsTest4", 500, 500);
        Render render = new Render() //
                .setImageWriter(imageWriter) //
                .setCamera(camera) //
                .setRayTracer(new BasicRayTracer(scene));
